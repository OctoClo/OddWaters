...
public class Telescope : MonoBehaviour
{
    ...
    // General
    [SerializeField]
    GameObject telescopeContainer;
    GameObject[] telescopes;
    GameObject[] telescopesPanoramaFolder;
    GameObject[] telescopesElementsFolder;
    [SerializeField]
    Sprite refPanorama;
    ...
    void Start()
    {
        ...
        GameObject telescope1 = telescopeContainer.transform.GetChild(0).gameObject;
        GameObject panoramaFolder1 = telescope1.transform.GetChild(0).gameObject;
        spriteZoneWidth = refPanorama.texture.width;
        spriteZonePPU = refPanorama.pixelsPerUnit;
        telescopeOffsetX = spriteZoneWidth * telescope1.transform.localScale.x / spriteZonePPU;

        // Clone telescope 1
        GameObject telescope2 = Instantiate(telescope1, telescopeContainer.transform);
        telescope2.name = "Telescope2";
        GameObject panoramaFolder2 = telescope2.transform.GetChild(0).gameObject;
        ...
        telescopesPanoramaFolder = new GameObject[2];
        telescopesPanoramaFolder[0] = panoramaFolder1;
        telescopesPanoramaFolder[1] = panoramaFolder2;

        telescopesElementsFolder = new GameObject[2];
        telescopesElementsFolder[0] = telescope1.transform.GetChild(1).gameObject;
        telescopesElementsFolder[1] = telescope2.transform.GetChild(1).gameObject;
    ...
    void Update()
    {
        ...
        else if (zoom)
        {
            ...
            for (int i = 0; i < elementsChildCount; i++)
            {
                TelescopeElement island3D1 = telescopesElementsFolder[0].transform.GetChild(i).GetComponent<TelescopeElement>();
                ...
                if (!island3D1.islandDiscover.visible)
                {
                    ...
                    TelescopeElement island3D2 = telescopesElementsFolder[1].transform.GetChild(i).GetComponent<TelescopeElement>();
        ...
        if (zoomAnimation)
        {
            ...
            telescopeOffsetX = spriteZoneWidth * telescopes[0].transform.localScale.x * telescopeContainer.transform.localScale.x / spriteZonePPU;
    ...
    public void RefreshElements(Vector3 boatUp, Vector3 target, Vector3 boatRight, GameObject panorama)
    {
        ...
        for (int i = 0; i < elementsChildCount; i++)
        {
            Destroy(telescopesElementsFolder[0].transform.GetChild(i).gameObject);
            Destroy(telescopesElementsFolder[1].transform.GetChild(i).gameObject);
        }
        ...
        foreach (Island island in boat.GetIslandsInSight())
        {
            ...
            island1.transform.parent = telescopesElementsFolder[0].transform;
            ...
            island2.transform.parent = telescopesElementsFolder[1].transform;
            ...
            offset *= telescopes[0].transform.localScale.x / spriteZonePPU;
